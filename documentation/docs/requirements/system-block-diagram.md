...
React Native manages the user interface, handles user input, displays context relevant icons, constructs sentences from selected symbols, and converts those sentences into speech using text-to-speech technology.
...
Expo-TTS handles multi-platform TTS calls by utilizing Android and iOS built in TTS functionality.
